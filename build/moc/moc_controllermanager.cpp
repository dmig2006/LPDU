...
QT_MOC_LITERAL(1, 18, 9), // "newPosX_Y"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 5), // "pPosX"
QT_MOC_LITERAL(4, 35, 5), // "pPosY"
QT_MOC_LITERAL(5, 41, 9) // "setPosX_Y"

    },
    "ControllerManager\0newPosX_Y\0\0pPosX\0"
    "pPosY\0setPosX_Y"
};
...
void ControllerManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ControllerManager *_t = static_cast<ControllerManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newPosX_Y((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->setPosX_Y((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (ControllerManager::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ControllerManager::newPosX_Y)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ControllerManager::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ControllerManager.data,
      qt_meta_data_ControllerManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ControllerManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ControllerManager.stringdata0))
        return static_cast<void*>(const_cast< ControllerManager*>(this));
...
// SIGNAL 0
void ControllerManager::newPosX_Y(int _t1, int _t2)
{
