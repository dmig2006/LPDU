...
QT_MOC_LITERAL(3, 23, 7), // "pString"
QT_MOC_LITERAL(4, 31, 8), // "newVideo"
QT_MOC_LITERAL(5, 40, 6), // "pImage"
QT_MOC_LITERAL(6, 47, 17), // "newCameraInversia"
QT_MOC_LITERAL(7, 65, 5), // "pFlag"
QT_MOC_LITERAL(8, 71, 7), // "logText"
QT_MOC_LITERAL(9, 79, 9), // "jpegFrame"
QT_MOC_LITERAL(10, 89, 2), // "jF"
QT_MOC_LITERAL(11, 92, 11) // "drawPicture"

    },
    "VideoWidget\0newLogMsg\0\0pString\0newVideo\0"
    "pImage\0newCameraInversia\0pFlag\0logText\0"
    "jpegFrame\0jF\0drawPicture"
};
...
void VideoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->newVideo((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 2: _t->newCameraInversia((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 3: _t->logText((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->jpegFrame((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        {
            typedef void (VideoWidget::*_t)(QImage );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoWidget::newVideo)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (VideoWidget::*_t)(bool , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoWidget::newCameraInversia)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void VideoWidget::newVideo(QImage _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void VideoWidget::newCameraInversia(bool _t1, QString _t2)
{
